export default function SearchIcon() {
  return (
    <button className="bg-black-100 w-14 h-14 rounded-lg flex justify-center items-center focus:outline-none transition duration-500 transform hover:scale-110 border border-gray-100">
